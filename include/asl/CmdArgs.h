...
The arguments given by this object with the `length()` property and the `[int]` operator are the rest arguments, not
...
Has the option `format` with value `jpeg`, the flag `fast`, the option `q` with value 85 and 2 rest arguments.
...
public:
	...
	*/
	...
	/** Returns the value of a flag option (if it exists with no value or has a value 1, true, yes or on) */
	...
	/** Returns the rest of arguments after the last option */
	Array<String> rest() const;
	/** Returns all the arguments, as received at main() */
	Array<String> all() const;
	/** Returns the number of rest arguments, those after the options */
	int length() const;
