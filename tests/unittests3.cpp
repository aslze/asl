...
ASL_TEST(SHA)
{
	...
	ASL_ASSERT(encodeHex(h1) == "a9993e364706816aba3e25717850c26c9cd0d89d");
	SHA1::Hash h2 = SHA1::hash("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq");
	ASL_ASSERT(encodeHex(h2) == "84983e441c3bd26ebaae4aa1f95129e5e54670f1");
	SHA256::Hash h3 = SHA256::hash("abc");
	ASL_CHECK(encodeHex(h3), ==, "ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad");
